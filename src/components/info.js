  ...
  return (
    <div>
        ...
        <div className="col-md-12 col-lg-4" style={{marginBottom:"1.2rem"}}>
         <div className="d-flex flex-row">
          <div>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 255.98 245.34" data-inject-url="https://www.augmntx.com/assets/img/icons/solid/paper-plane.svg" class="svg-inject icon-svg icon-svg-sm solid-mono text-navy me-4"><path class="fill-secondary" d="M93.32 187.87v49.47a8 8 0 0014.45 4.74l28.92-39.4z"></path><path class="fill-primary" d="M252.63 1.48a8 8 0 00-8.34-.57l-240 125.33a8 8 0 001.12 14.67l66.72 22.8L214.21 42.22 104.26 174.68l111.81 38.21a8 8 0 002.59.43 8 8 0 007.91-6.83L255.89 9.16a8 8 0 00-3.26-7.68z"></path></svg>
          </div>
        <div>
           <h4 className="mb-1 info-header">Fast onboarding</h4> <p className="mb-0 info-p">You'll be able to get an developer working on your project within 2 to 3 business days.</p> </div>
         </div> 
         </div>
        <div className="col-md-12 col-lg-4" style={{marginBottom:"1.2rem"}}>
         <div className="d-flex flex-row"> 
         <div>
         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256.01 256" data-inject-url="https://www.augmntx.com/assets/img/icons/solid/globe-2.svg" class="svg-inject icon-svg icon-svg-sm solid-mono text-navy me-4">
